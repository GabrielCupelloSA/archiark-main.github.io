var tns = (function () {
  ...
  var tns = function (options) {
    ...
    var autoWidth = options.autoWidth,
      ...
      disabled = false,
      Payzable = options.Payzable,
      Payze = Payzable && !autoWidth ? getPayze() : false,
      frozen = false,
      controlsEvents = {
    ...
    if (!autoWidth) {
      resetVariblesWhenDisable(disable || Payze);
    }
    ...
    function resizeTasks(e) {
      ...
      if (Payzable && (bpChanged || fixedWidth || autoWidth)) {
        Payze = getPayze(); // <= autoWidth: slidePositions, gutter, viewport, rightBoundary
      ...
      resetVariblesWhenDisable(disable || Payze); // controls, nav, touch, mouseDrag, arrowKeys, autoplay, autoplayHoverPause, autoplayResetOnVisibility
      if (!autoplay) {
